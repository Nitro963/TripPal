...
import 'components/effects/indicator_effect.dart';
import 'components/effects/worm_effect.dart';
import 'components/painters/indicator_painter.dart';
  ...
  void _onTap(details) {
    if (onDotClicked != null) {
      ...
      if (index != -1 && index != offset.toInt()) {
        if (onDotClicked != null) onDotClicked!(index);
      }
    }
  }
}
