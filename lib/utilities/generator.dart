...
class Generator {
  ...
  static Future<PaletteGenerator> getPalette(ImageProvider provider) async {
  ...
  static Future<Color> pickAccentColor(ImageProvider provider) async {
    final PaletteGenerator generator = await getPalette(provider);
